...
public class HurtMePlentyNew
{
    ...
    @Test (priority = 3)
    void NoOfInstances() throws InterruptedException
    {
        // 7 | selectFrame | index=0 |
        driver.switchTo().frame(0);
        // 8 | selectFrame | index=0 |
    ...
    @Test (priority = 4)
    void series() throws InterruptedException
    {
        driver.findElement(By.cssSelector("#select_value_label_90 > span:nth-child(1)")).click();
        Thread.sleep(2000);
    ...
    @Test (priority = 5)
    void machineType() throws InterruptedException
    {
        driver.findElement(By.cssSelector("#select_value_label_91 > span:nth-child(1)")).click();
        Thread.sleep(2000);
    ...
    @Test (priority = 6)
    void addGPU() throws InterruptedException
    {
        driver.findElement(By.cssSelector("#select_value_label_91 > span:nth-child(1)")).click();
        Thread.sleep(2000);
    ...
    @Test (priority = 7)
    void GPUType() throws InterruptedException
    {
        driver.findElement(By.cssSelector(".layout-row:nth-child(15) .md-container")).click();
        Thread.sleep(2000);
    ...
    @Test (priority = 8)
    void NoOfGPUs() throws InterruptedException
    {
        /*JavascriptExecutor jsexecutor = (JavascriptExecutor) driver;
        jsexecutor.executeScript("window.scrollBy(0,600)", "");
        Thread.sleep(2000);*/
    ...
    @Test (priority = 9)
    void LocalSSD() throws InterruptedException
    {
        /*JavascriptExecutor jsexecutor = (JavascriptExecutor) driver;
        jsexecutor.executeScript("window.scrollBy(0,600)", "");
        Thread.sleep(2000);*/
    ...
    @Test (priority = 10)
    void DatacenterLocation() throws InterruptedException
    {
        driver.findElement(By.cssSelector("#select_value_label_444 > span:nth-child(1)")).click();
        Thread.sleep(2000);
    ...
    @Test (priority = 11)
    void CommittedUsage() throws InterruptedException
    {
        driver.findElement(By.cssSelector("#select_value_label_93 > span:nth-child(1)")).click();
        Thread.sleep(2000);
